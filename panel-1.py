    ...
    try:
        ...
        for otp_data in otps:
            try:
                ...
                country_names = {
                    "1": "USA", "7": "Russia", "91": "India", "92": "Pakistan", "95": "Myanmar", "212": "Morocco",
                }
                ...
                msg = (
                    ...
                    f"⏰ Time: `{dt}`\n\n"
                    f"───────────────────\n"
                    f"[👨‍💻 Developer](https://t.me/{DEVELOPER_USERNAME}) | [🤖 Number Bot](https://t.me/pc_clonev1_bot)"
                )
...
async def reply_keyboard_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if text == "📲 Get Number":
        ...
        country_flags = {
            "1": "🇺🇸", "7": "🇷🇺", "91": "🇮🇳", "92": "🇵🇰", "95": "🇲🇲", "212": "🇲🇦", "213": "🇩🇿",
        }
        
        country_names = {
            "1": "USA", "7": "Russia", "91": "India", "92": "Pakistan", "95": "Myanmar", "212": "Morocco", "213": "Algeria",
        }
...
async def button_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if data == "verify_channel":
        # Add to verified users (no channel check needed)
        if str(user_id) not in bot_data.get("verified_users", []):
        ...
        # Direct redirect to OTP channel - no message
        try:
            await context.bot.send_message(
                chat_id=user_id,
                text=f"📱 Opening OTP Channel...",
                reply_markup=InlineKeyboardMarkup([
                    [InlineKeyboardButton("📱 Open Channel", url=OTP_CHANNEL_LINK)]
                ])
            )
        except:
            pass
        await query.answer("✅ Opening OTP Channel...")
